    ...
    try:
        if proxies!='':
            if attack =='get':
                ...
                r = s.delete(target, params=payload, headers=headers, timeout=20 ,verify=False,proxies=proxies)
            else:
